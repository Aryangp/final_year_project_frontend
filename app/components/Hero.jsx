...
const Hero = () => {
  return (
    <div className="h-[50rem] w-full dark:bg-custom1 bg-custom1 dark:bg-grid-white/[0.2] bg-grid-custom4/[0.2] relative flex flex-col items-center justify-center">
      ...
      <p className="text-3xl sm:text-6xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-custom4 to-custom5 py-8 mb-5">
        Instantly Summarize Your Documents with Ease!
      </p>
